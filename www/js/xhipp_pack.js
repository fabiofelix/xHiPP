...
var xHiPP_pack = function()
{
  this.pack = function(tree, summary, Xf, Yf)
  {
    ...
    //Al�m de colocar a coordenada y entre 0 e Yf, tamb�m inverte os valores por causa da localiza��o do ponto (0, 0) na tela
  ...
  //   var max       = 20;
  //   var threshold = 1.5;   //se os n�s n�o possuirem interse��o mas estiverem muito pr�ximos faz com que sejam minimamente afastados
