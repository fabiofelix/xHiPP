...
//Fábio: Incompatibility with other libs., like KolorWheel.js
...
//     Array.prototype.contains = function(obj) {
    ...
    function setElementValue(element, value, name) {
      ...
      switch (type) {
        ...
        case 'checkbox':
//Fábio: .val() is always returning 'on', even if the checkbox be checked or not.
//       When value is boolean, I just want that checkbox be checked or not.          
          var elementValue = $element.val();
          
//           if ((value.constructor == Array && value.contains(elementValue)) || value == elementValue) {
//           if ((value.constructor == Array && value.contains(elementValue)) || value.constructor == String && value == elementValue || value) {
          if ((value.constructor == Array && contains(value, elementValue)) || value.constructor == String && value == elementValue || value) {              
            $element.prop('checked', true);
          } else {
            $element.prop('checked', false);
          }
    ...
    function browseJSON(obj, element, name) {
      ...
      // no object
//Fábio: 'null' should be disconsidered , as well.
